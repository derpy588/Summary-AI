...
**Input:** Takes text large article or document

**Output:** summary of the document or article
...
- [X] Save and load model in different formats (e.g. .pt, .pth, .safetensor)
- [ ] Implement custom tokenizer (Currently using pretrained bart-large tokenizer)
- [X] Option to save model every epoch during training
- [X] Option to put batch data onto training device
- [ ] Create a test/validation function for ModelBase class
- [ ] Multi GPU training support using DDP or DataParallel